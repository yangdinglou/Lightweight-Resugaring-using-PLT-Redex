...
\begin{enumerate}
    ...
    \item Then some sugar definitions are needed to construct the surface language.
    \item We need some calculation based on our approach, described in the following chapter.
    \item Finally, given a program in the surface language, we will obtain the evaluation sequences of the program at the surface level.
\end{enumerate}
   }
