...
\ycomment{Another point is that the core language can be carefully designed to (1) powerful enough to express any computation, (2) slight enough to define sugar easily. Given a proper core language, the only afford to build any surface language is defining the desugaring rules. (Other steps of the resugaring can be done automatically.)}