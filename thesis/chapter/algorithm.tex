...
\begin{figure}[h]
	...
	\framebox[35em][l]{
		\parbox{\textwidth}{
			$f$($Exp$): \qquad \qquad \qquad \qquad \qquad \qquad \qquad //$Exp$=$(Headid~Subexp_{1}~\ldots~Subexp_{\ldots})$
			
			\qquad Let $ListofExp'~=~\{Exp'_{1}\;,Exp'_{2}~\ldots\}$
			
			\qquad if(Exp is Coreexp or Commonexp or OtherCommonexp):
			
			\qquad \qquad if(Lengthof ($ListofExp'$) == 0): \qquad \qquad \qquad \qquad \qquad \qquad \quad//$Rule1.3$
			
			\qquad \qquad \qquad return null;
			
			\qquad \qquad else if(Lengthof ($ListofExp'$) == 1): \qquad \qquad \qquad \qquad \qquad \quad ~//$Rule1.1$
			
			\qquad \qquad \qquad return first($ListofExp'$);
			
			\qquad \qquad else:
			
			\qquad \qquad \qquad return $Exp'_{i}$=$(Headid~Subexp_{1}~\ldots~Subexp'_{i}~\ldots)$; \qquad \qquad //$Rule1.2$ 
			
			/*where i is the index of subexp which have to be reduced. */
			
			\qquad else if(Exp is Surfexp or OtherSurfexp):
			
			\qquad \qquad if(Exp have to be desugared): \qquad \qquad \qquad \qquad \qquad \qquad \qquad ~~//$Rule2.1$
			
			\qquad \qquad \qquad return desugarsurf(Exp);
			
			\qquad \qquad else: let DesugarExp' = desugarsurf(Exp): \qquad \qquad \qquad \qquad \quad ~//$Rule2.2$

			
			\qquad \qquad \qquad if($Subexp_{i}$ is reduced to $Subexp'_{i}$ during $f(DesugarExp')$):
			
			\qquad \qquad \qquad \qquad return $Exp'_{i}$=$(Headid~Subexp_{1}~\ldots~Subexp'_{i}~\ldots)$; \quad ~//$Rule2.2.1$
			
			\qquad \qquad \qquad else:
			
			\qquad \qquad \qquad \qquad return desugarsurf(Exp); \qquad \qquad \qquad \qquad \qquad \quad ~~~//$Rule2.2.2$
		}
	}
\caption{核心算法f}
\label{fig:corealgo}
