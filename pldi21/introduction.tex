...
\end{array}
\]
If we use binder renaming for solving the simple case, some other information is needed (such as the permutation).\gcomment{In the hygiene example, the expression in CoreLang may have a one-step eval then resugar?}
