...
\gcomment{(1) Fig 1 should be changed to Fig. 1 or Figure 1. I am not sure whether it shoule be capital. The paper Inferring Type Rules uses format like fig. 1 and section 1. (2) Don't forget to adjust the upper/lower case of syntactic sugar. Also, \m{nNotif} or \m{nNotIf}, and \m{hHygienicadd} or \m{hHygienicAdd}, I prefer the second ones.}


Syntactic sugar, first coined by Peter J. Landin in 1964 \cite{syntacticsugar}, was introduced to describe the surface syntax of a simple ALGOL-like programming language which was defined semantically in terms of the applicative expressions of the core lambda calculus. It has proved\gcomment{It has been proved} to be very useful for defining domain-specific languages (DSLs) and extending languages \cite{FellFFKBMT18,CulpFFK19}.
