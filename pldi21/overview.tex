...
Now let us demonstrate how to execute \Code{(And (Or \true~\false) (And \false ~\true))}, and get the resugaring sequences as Figure \ref{fig:standard} by both the existing approach and our new approach.
