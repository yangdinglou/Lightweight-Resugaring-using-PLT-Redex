...
Finally the program \Code{(And (Or \true~\false) (And \false~\true))} will got the evaluation sequence as follows in the mixed language. We can just filter the intermediate sequences without \m{Coreexp} in any sub-expressions to get the resugaring sequence above. \todo{program/expression/term; desugared/expanded}
