...
}{Example1 of algorithm \m{calcontext}}{example:algo1}
...
\hfill\Code{(Sg2 $[\bigcdot]~e_2~e_3~e_4$), (Sg2 $v_1~[\bigcdot]~e_3~e_4$)})
}{Example2 of algorithm \m{calcontext}}{example:algo2}
...
}{Example of property \ref{thm1}}{example:ppt2}
