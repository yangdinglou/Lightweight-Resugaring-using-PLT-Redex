...
The properties restricts how the lazy desugaring of our mixed language should be---the resugaring sequences should behave as the sequences after desugared to the core language.
