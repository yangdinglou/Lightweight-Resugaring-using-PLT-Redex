...
\end{array}
\]
During the resugaring, we just apply the reduction ($\redm{}{}$) on the input program step by step until no reduction can be applied (\m{isNormal}), while outputting those intermediate expressions that belong to \m{DisplayableExp}.
