...
For the case1, the very basic and common hygienic problem, is not a problem, because our "lazy desugaring" setting will not let the sugar \m{Or} expanded before the x is substituted. Because the bound variables in sugar expressions are only introduced by let-binding, all of them can "delay" the expansion of the syntactic sugar.
