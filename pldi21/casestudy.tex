...
\begin{figure}[thb]
  ...
  \label{fig:step}
  \end{figure}
The general regularity is that, the more complex the sugar is, the more steps will our approach save. Note that if the RHS of a syntactic sugar is huge, one step reduction of the reverse desugaring will also be more complex.
