...
Take \Code{(Odd 2)} as an example. The previous work will firstly desugar the expression using the rules. Then the desugaring will never terminate as following shows.
\begin{footnotesize}
\begin{Codes}
   (Odd 2)
