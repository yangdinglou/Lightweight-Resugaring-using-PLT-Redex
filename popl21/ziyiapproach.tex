...
We let {\bfseries if}, {\bfseries let}, {\bfseries lamN} (call-by-name lambda calculus), {\bfseries empty}, {\bfseries first}, {\bfseries rest} as Coreexp's Headid, {\bfseries Op}, {\bfseries lam}(call-by-value lambda calculus), {\bfseries cons} as Commonexp's Headid. Then we could show some useful intermediate steps.
