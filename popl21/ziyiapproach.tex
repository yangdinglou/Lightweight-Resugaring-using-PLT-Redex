...
We may assume {\bfseries if}, {\bfseries let}, {\bfseries lamN} (call-by-name lambda calculus), {\bfseries empty}, {\bfseries first}, {\bfseries rest} as \m{CoreExp}'s \m{Headid}, {\bfseries Op}, {\bfseries lam} (call-by-value lambda calculus), {\bfseries cons} as \m{CommonExp}'s \m{Headid}. Then we could show some useful intermediate steps.
