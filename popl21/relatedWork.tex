...
As discussed many times before, our work is much related to the pioneer work of resugaring in \cite{resugaring,hygienic}. The idea of "tagging" and "reverse desugaring" is a clear explanation of "resugaring", but it becomes very complex when the RHS of the desugaring rule becomes complex. Our approach does not need reverse desugaring, and is more lightweight, powerful and efficient.
...
For desugaring rules in a good form as given in Section \ref{sec:ruleDerivation}, we can easily track the terms and make use of them for derivation of evaluation rules. \todo{Add more related work about derivation of reductions rules by Zhichao.}
%
